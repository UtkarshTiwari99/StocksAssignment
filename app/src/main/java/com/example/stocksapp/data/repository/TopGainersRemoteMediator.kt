...
@Singleton
class TopGainersRemoteMediator @Inject constructor(
    ...
    val stockCategory:String= StockCategory.TOP_GAINERS.stockCategory
        ...
        try {
            ...
            val jobs=CoroutineScope(Dispatchers.IO+handler).launch {
                val jobs = (startIdx..endIdx).map {
                    Log.e("Assignment Network $stockCategory", "$it Request")
            ...
            localStockDatabase.withTransaction {
                ...
                val remoteKeys = stocks.map {
                    RemoteDataKeys(
                        ...
                        currentPage = page,
                        nextKey = nextKey,
                        stockCategory = StockCategory.TOP_GAINERS.stockCategory
                    )
                }
            ...
            Log.e("Groww Assingment Mediator $stockCategory","end $endOfPaginationReached $startIdx $endIdx load ${stockList.size}  ${stocks.size}")
